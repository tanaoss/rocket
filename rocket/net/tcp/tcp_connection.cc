...
void TcpConnection::clear() {
  ...
  m_fd_event->cancle(FdEvent::TriggerEvent::IN_EVENT);
  m_fd_event->cancle(FdEvent::TriggerEvent::OUT_EVENT);
...
void TcpConnection::listenWrite() {
  ...
  m_fd_event->listen(FdEvent::TriggerEvent::OUT_EVENT, std::bind(&TcpConnection::onWrite, this));
  m_event_loop->addEpollEvent(m_fd_event);
}
...
void TcpConnection::listenRead() {
  ...
  m_fd_event->listen(FdEvent::TriggerEvent::IN_EVENT, std::bind(&TcpConnection::onRead, this));
  m_event_loop->addEpollEvent(m_fd_event);
}
